...
Write-Host "PostAngel v0.3.1 Build and Release Script" -ForegroundColor Cyan
...
$commitMessage = "Version 0.3.1: Fixed layout issues with response text box in Create Post"
git add .
...
Write-Host "Creating git tag v0.3.1..." -ForegroundColor Green
...
if ($response -eq "y") {    Write-Host "Pushing changes to remote..." -ForegroundColor Green
    ...
    Write-Host "Changes and tag v0.3.1 successfully pushed to remote!" -ForegroundColor Green
} else {
